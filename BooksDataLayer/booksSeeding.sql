...
-- Video media
INSERT INTO [dbo].[Media] (ISBN,  ContentLocation, [Title], [Description], [Level], Pages, [LanguageId], PublisherId, YearPublished, IsFree, Price, MediaType, IsPartOfACollection, MediaCollectionId)
	VALUES ('978-3-16-148419-0', null, N'Earth', 'Videos about Earth as seen from the International Space Station.', 1, 5, @languageId1, @publisher1, 2016, 'True', 0.00, @MediaTypeVideo, 'False', null)
...
INSERT INTO [dbo].Chapters(Title, MediaId, StartingPage) Values('2 - Moon Shadow''s a Cast On Earth Seen From Space', @mediaId, 2)
INSERT INTO [dbo].Chapters(Title, MediaId, StartingPage) Values('3 - ISS Crew Earth Observations', @mediaId, 3)
INSERT INTO [dbo].Chapters(Title, MediaId, StartingPage) Values('4 - ISS Earth Illuminated', @mediaId, 4)
INSERT INTO [dbo].Chapters(Title, MediaId, StartingPage) Values('5 - ISS Earth from orbit', @mediaId, 5)
...
INSERT INTO [dbo].ContentPages(MediaId, [Sequence], Content) Values(@mediaId, 3, 'https://svs.gsfc.nasa.gov/vis/a030000/a030700/a030771/ISS_Crew_Earth_Observations_2160p.mp4')
INSERT INTO [dbo].ContentPages(MediaId, [Sequence], Content) Values(@mediaId, 4, 'https://svs.gsfc.nasa.gov/vis/a010000/a011400/a011474/Earth_Illuminated-540-MASTER_high.mp4')
INSERT INTO [dbo].ContentPages(MediaId, [Sequence], Content) Values(@mediaId, 5, 'https://svs.gsfc.nasa.gov/vis/a010000/a011200/a011268/11243-540-MASTER_high.mp4')
INSERT INTO [dbo].MediaAuthors(Author_Id, Media_Id) Values(@authorId1, @mediaId)
